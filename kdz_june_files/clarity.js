...
;(function () {
  ...
  const sid = (parentClarityQueryData && parentClarityQueryData.sid) || cookieSid || "w9vDoprtqPSRoFjZH_nRgeSc57dhN9zO:1782021392345";
  ...
  function trackBehaviour() {
    ...
    const browserSessionId = sessionStorage.getItem('clrt-v8-session-id') || "ulOTI7tEvziyXPY3SoJq11VqoYh-xaVH";
