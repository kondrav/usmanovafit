		...
		init: function (c) {
			return this.each(function () {
				...
				var f = d.settings = b.extend({
					...
					simUploadLimit: /android/i.test(navigator.userAgent) ? 1 : 0,
					truncateLength: 0,
					uploadLimit: 0,
				...
				d.uploadFile = function (k, l) {
					if (!k.skip && !k.complete && !k.uploading) {
						...
						if (typeof FormData === "function" || typeof FormData === "object") {
							var m = new FormData();
							try {
								m.append(f.fileObjName, /android/i.test(navigator.userAgent) ? k.slice(0, k.size, k.type) : k, k.name);
							} catch (uploadifiveErr) {
				...
				d.error = function (l, j, k) {
					if (b.inArray("onError", f.overrideEvents) < 0) {
						...
						if (typeof Yii != 'undefined') {
							errorMsg = Yii.t('common', errorMsg);
						}
