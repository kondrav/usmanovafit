...
;(function () {
  ...
  const uid = queryUid || (parentClarityQueryData && parentClarityQueryData.uid) || cookieUid || "m0BsoAY8AWP_GbPQMZKJ9Qu3TqLyEypt";
  const sid = (parentClarityQueryData && parentClarityQueryData.sid) || cookieSid || "woTGBMBCDdtJJHx8XuSJt35mDl2RhgZ2:1781981646012";
  ...
  function trackBehaviour() {
    ...
    const browserSessionId = sessionStorage.getItem('clrt-v8-session-id') || "CysxkNcftH1grc2jcB-lmX0L3RwQ6kgj";
